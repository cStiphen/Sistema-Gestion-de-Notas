                    ...
                    <table class="responsive-table striped bordered" id="asignaturas">
                        ...
                        <tbody>
                            @foreach ($asignaturas as $asignatura)
                                <tr>
                                    <td class="center">{{ $asignatura->programaAcademicoAsignatura->asignatura->Codigo}}</td>
                                    <td class="center">{{ $asignatura->programaAcademicoAsignatura->asignatura->Nombre}}</td>
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $(data).each(function(key,value){
                    ...
                    tablaAsignaturas.append("<tr><td>"+value.nombre+" "+value.apellidos +"</td><td>"+value.cantidadEstudiantes+"</td></tr>");    
                });
